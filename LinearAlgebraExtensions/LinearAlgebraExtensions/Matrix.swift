...
public struct NumberGenerators {
	public static func UniformDistribution() -> Double {
		return Double(arc4random()) / Double(UInt32.max)
	}
	
	public static func NormalDistribution(mu: Double = 0.0, sigma: Double = 1.0) -> NumberGenerator {
		return { idx in
...
*/
public func eye(dimension: Int = 1) -> la_object_t {
